        ...
        "/v1/customers": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search by tax ID (bypasses pagination)",
                        "name": "taxId",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filter by status (pending, approved, active, suspended, blocked, terminated)",
                        "name": "status",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.PaginatedCustomers"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "domain.Customer": {
            ...
            "properties": {
                ...
                "countryCode": {
                    "description": "Tax residency / Tax jurisdiction (e.g., \"BR\", \"US\")",
                    "type": "string"
                },
                "createdAt": {
                    "description": "For Audit",
                ...
                "status": {
                    "description": "eg: \"pending\", \"approved\", \"active\", \"blocked\", \"terminated\"",
                    "type": "string"
                },
                "taxId": {
                    "description": "Unique national identifier for tax purposes",
                    "type": "string"
                },
                "updatedAt": {
                    "description": "For Audit",
        ...
        "domain.PaginatedCustomers": {
            ...
            "properties": {
                ...
                "meta": {
                    "$ref": "#/definitions/domain.PageMeta"
                }
            }
        },
        "domain.Phone": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "eg: \"mobile\", \"landline\"",
                    "type": "string"
                },
                "updatedAt": {
                    "description": "For Audit",
